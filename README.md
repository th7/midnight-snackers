...
### Sample OpModes
The SDK's sample OpModes are not kept in this repository. They live upstream in the
[FtcRobotController samples folder](https://github.com/FIRST-Tech-Challenge/FtcRobotController/tree/master/FtcRobotController/src/main/java/org/firstinspires/ftc/robotcontroller/external/samples)
and can be copied into TeamCode when one is needed.
